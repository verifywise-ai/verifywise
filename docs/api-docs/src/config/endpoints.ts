...
// Regulations Tracker endpoints
export const regulationsTrackerEndpoints: Endpoint[] = [
  {
    method: 'GET',
    path: '/regulations-tracker/countries',
  ...
  {
    method: 'POST',
    path: '/regulations-tracker/tracked/bulk',
    summary: "Track Bulk Ctrl",
    requiresAuth: true,
    responses: [
      { status: 200, description: "Success" },
      { status: 500, description: "Internal server error" },
  ...
  {
    method: 'DELETE',
    path: '/regulations-tracker/tracked/{slug}',
    summary: "Untrack Country Ctrl",
    requiresAuth: true,
    responses: [
      { status: 200, description: "Success" },
      { status: 500, description: "Internal server error" },
...
export const allEndpoints = {
  ...
  regulationsTracker: regulationsTrackerEndpoints,
