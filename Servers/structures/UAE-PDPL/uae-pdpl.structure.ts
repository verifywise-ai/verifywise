...
export const uaePdplStructure: FrameworkStructure = {
  ...
  seed: {
    ...
    "description": "Framework for compliance with UAE PDPL 45/2021, DIFC Regulation 10, and AI Ethics Charter (2024)",
    "version": "1.0.0",
        ...
        "items": [
          {
            ...
            "description": "Key definitions including personal data, sensitive data, data controller, data processor, and consent",
            "order_no": 1,
          ...
          },
          {
            ...
            "description": "Law applies to processing within UAE and to UAE residents' data processed abroad",
            "order_no": 2,
