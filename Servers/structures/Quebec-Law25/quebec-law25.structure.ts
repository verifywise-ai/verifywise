...
export const quebecLaw25Structure: FrameworkStructure = {
  ...
  seed: {
    ...
    description:
      "Framework for ensuring compliance with Quebec's modernized privacy law (Law 25/Bill 64) which came into force in phases from 2022-2024",
    version: "1.0.0",
    ...
    structure: [
      {
        ...
        description:
          "Organizational governance requirements including privacy officer designation, privacy policies, and accountability measures",
        order_no: 1,
        items: [
          {
            title: "Art. 1.1 - Privacy Officer Designation",
            description:
              "Designate a person responsible for personal information protection (Privacy Officer) and publish their contact information",
            order_no: 1,
            summary:
              "Mandatory designation of a person responsible for protecting personal information within the organization, with title and contact information publicly accessible on the organization's website",
            questions: [
          ...
          },
          {
            ...
            description:
              "Establish policies and practices governing personal information protection and retention/destruction schedules",
            order_no: 2,
            summary:
              "Implement comprehensive governance policies including data collection, use, disclosure, retention, and destruction procedures, published on the website in clear language",
            questions: [
          ...
          },
          {
            ...
            description:
              "Conduct Privacy Impact Assessments (PIAs) for new projects, systems, or initiatives involving personal information",
            order_no: 3,
            summary:
              "Mandatory PIAs before acquiring, developing, or redesigning information systems or electronic service delivery involving personal information. Required for any disclosure outside Quebec",
            questions: [
          ...
          },
          {
            ...
            description:
              "Ensure staff handling personal information receive appropriate privacy training",
            order_no: 4,
            summary:
              "Provide regular training to employees on privacy obligations, proper handling of personal information, and incident response procedures",
            questions: [
          ...
          },
          {
            ...
            description:
              "Maintain an inventory of personal information holdings and processing activities",
            order_no: 5,
            summary:
              "Document all personal information collected, purposes, retention periods, access controls, and third-party disclosures",
            questions: [
      ...
      },
      {
        ...
        description:
          "Requirements for obtaining valid consent for collection, use, and disclosure of personal information",
        order_no: 2,
        items: [
          {
            ...
            order_no: 1,
            summary:
              "Express consent required for: sensitive personal information, disclosure to third parties, new purposes, profiling/targeting, automated decision-making, and identification/location technologies",
            questions: [
          ...
          },
          {
            ...
            order_no: 2,
            summary:
              "Individuals must be able to withdraw consent as easily as it was given. Organization must cease processing upon withdrawal unless legal grounds exist",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "Parental consent required for minors under 14. For minors 14 and over, their own consent or parental consent may be required depending on context",
            questions: [
          ...
          },
          {
            ...
            order_no: 4,
            summary:
              "New consent required when personal information is to be used for purposes not initially disclosed, unless exemption applies",
            questions: [
      ...
      },
      {
        ...
        description:
          "Rights of individuals regarding access, rectification, portability, and erasure of their personal information",
        order_no: 3,
        items: [
          {
            title: "Art. 3.1 - Right of Access",
            description:
              "Individuals have the right to access their personal information held by the organization",
            order_no: 1,
            summary:
              "Respond to access requests within 30 days (extendable by 10 days with notice). Provide information in understandable form. May charge reasonable fee for reproduction",
            questions: [
          ...
          },
          {
            ...
            description:
              "Individuals have the right to request rectification of inaccurate, incomplete, or equivocal personal information",
            order_no: 2,
            summary:
              "Correct inaccurate information upon request. Notify third parties who received the incorrect information. Provide written reasons if rectification is refused",
            questions: [
          ...
          },
          {
            ...
            description:
              "Individuals have the right to obtain their personal information in a portable format",
            order_no: 3,
            summary:
              "Upon request, provide personal information in a commonly used, structured technological format. Right to have information transferred to another organization. Applies to information provided by the individual",
            questions: [
          ...
          },
          {
            ...
            description:
              "Individuals have the right to request de-indexation or cessation of dissemination of personal information",
            order_no: 4,
            summary:
              "Upon request, cease disseminating personal information or de-index hyperlinks if: dissemination contravenes law, or causes serious harm and cessation does not exceed public interest",
            questions: [
          ...
          },
          {
            ...
            description:
              "Individuals have rights regarding decisions made exclusively through automated processing",
            order_no: 5,
            summary:
              "Individuals must be informed of automated decisions affecting them. Right to be informed of personal information used. Right to present observations to person who can review the decision",
            questions: [
      ...
      },
      {
        ...
        description:
          "Requirements for detecting, responding to, and reporting privacy incidents (data breaches)",
        order_no: 4,
        items: [
          {
            ...
            order_no: 1,
            summary:
              "Establish processes to detect unauthorized access, use, disclosure, loss, or other breach of personal information. Assess risk of serious harm to affected individuals",
            questions: [
          ...
          },
          {
            ...
            order_no: 2,
            summary:
              "If incident presents risk of serious harm, notify Commission d'accès à l'information (CAI) with diligence. Include incident details, categories of information affected, and mitigation measures",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "Notify affected individuals with diligence. Include description of incident, information affected, measures taken, steps individuals can take, and contact information for questions",
            questions: [
          ...
          },
          {
            ...
            order_no: 4,
            summary:
              "Keep written record of all confidentiality incidents, whether or not they present risk of serious harm. Register must be available to CAI upon request",
            questions: [
          ...
          },
          {
            ...
            order_no: 5,
            summary:
              "After incidents, review root cause and implement measures to prevent recurrence. Update security measures and procedures as needed",
            questions: [
        ...
        items: [
          {
            ...
            description:
              "Conduct assessment before transferring personal information outside Quebec",
            order_no: 1,
            summary:
              "Before communicating personal information outside Quebec, assess whether receiving jurisdiction provides adequate protection. Consider legal framework, applicable laws, and data protection rules",
            questions: [
          ...
          },
          {
            ...
            order_no: 2,
            summary:
              "When transferring outside Quebec, use written agreements that include protections comparable to Law 25. Agreements must address security, use limitations, and return/destruction obligations",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "Mandatory Privacy Impact Assessment required before any disclosure of personal information outside Quebec to evaluate risks and mitigations",
            questions: [
          ...
          },
          {
            ...
            order_no: 4,
            summary:
              "Public bodies face additional restrictions and must ensure destination jurisdiction provides substantially similar protection before transferring personal information",
            questions: [
        ...
        items: [
          {
            ...
            description:
              "Conduct due diligence before engaging service providers who process personal information",
            order_no: 1,
            summary:
              "Assess third-party privacy practices, security measures, and compliance capabilities before engaging them to process personal information",
            questions: [
          ...
          },
          {
            ...
            description:
              "Establish written agreements with third parties processing personal information",
            order_no: 2,
            summary:
              "Written contract required specifying: privacy and security measures, use restrictions, return/destruction obligations, audit rights, and breach notification requirements",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "Implement ongoing monitoring of third-party compliance including periodic reviews, audits, and incident tracking",
            questions: [
          ...
          },
          {
            ...
            order_no: 4,
            summary:
              "Require notification or approval for sub-processor engagement. Ensure same contractual protections flow down to sub-processors",
            questions: [
      ...
      },
      {
        ...
        description:
          "Special requirements for sensitive and specific categories of personal information",
        order_no: 7,
        items: [
          {
            ...
            order_no: 1,
            summary:
              "Sensitive information includes: health information, biometric data, information of a highly personal nature. Requires express consent and enhanced security measures",
            questions: [
          ...
          },
          {
            ...
            order_no: 2,
            summary:
              "Biometric data for identification purposes requires express consent and notification of any biometric database creation. Enhanced security and retention limits apply",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "De-identification must be performed according to generally accepted best practices. Risk of re-identification must be assessed and minimized",
            questions: [
          ...
          },
          {
            ...
            order_no: 4,
            summary:
              "Protection generally ceases 30 years after death. Before that, heirs and legal representatives may exercise certain rights on behalf of deceased",
            questions: [
      ...
      },
      {
        ...
        description:
          "Requirements related to specific technologies including profiling, automated decisions, and AI",
        order_no: 8,
        items: [
          {
            title: "Art. 8.1 - Automated Decision-Making",
            description:
              "Requirements when decisions are made exclusively through automated processing",
            order_no: 1,
            summary:
              "When decisions producing legal effects are made solely by automated means: inform individual at or before decision, explain information used, and allow human review on request",
            questions: [
          ...
          },
          {
            ...
            description:
              "Requirements for profiling activities used for targeting or personalization",
            order_no: 2,
            summary:
              "Profiling for targeted advertising or content personalization requires express consent. Individuals must be able to opt out. Profiling activities must be disclosed",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "Express consent required before using functions that allow identification or location tracking. Applies to facial recognition, location services, device identification, etc.",
            questions: [
          ...
          },
          {
            ...
            description:
              "Transparency requirements for artificial intelligence systems processing personal information",
            order_no: 4,
            summary:
              "When AI systems make decisions or process personal information, ensure transparency about AI use, explain logic involved, and enable human oversight where appropriate",
            questions: [
      ...
      },
      {
        ...
        description:
          "Technical and organizational security measures to protect personal information",
        order_no: 9,
        items: [
          {
            title: "Art. 9.1 - Security Program",
            description:
              "Implement a comprehensive security program to protect personal information",
            order_no: 1,
            summary:
              "Establish security measures reasonable having regard to sensitivity of information, purposes, quantity, distribution, format, and method of storage",
            questions: [
          ...
          },
          {
            ...
            order_no: 2,
            summary:
              "Restrict access to personal information to authorized personnel on need-to-know basis. Implement authentication, authorization, and access logging",
            questions: [
          ...
          },
          {
            ...
            order_no: 3,
            summary:
              "Use encryption for sensitive data at rest and in transit. Implement data masking, tokenization, and other technical protections as appropriate",
            questions: [
          ...
          },
          {
            ...
            description:
              "Implement secure destruction of personal information when no longer needed",
            order_no: 4,
            summary:
              "Destroy or anonymize personal information when purpose achieved and retention period expired. Use secure destruction methods that prevent reconstruction",
            questions: [
        ...
        items: [
          {
            ...
            order_no: 1,
            summary:
              "Regularly audit and monitor compliance with Law 25 requirements. Document findings and implement corrective actions",
            questions: [
          ...
          },
          {
            ...
            description:
              "Cooperate with Commission d'accès à l'information inquiries and investigations",
            order_no: 2,
            summary:
              "Respond to CAI inquiries and cooperate with investigations. Provide requested information and documentation in a timely manner",
            questions: [
          ...
          },
          {
            ...
            description:
              "Understand and implement measures to avoid administrative monetary penalties",
            order_no: 3,
            summary:
              "Understand penalty framework (up to $10M or 2% global revenue for serious violations). Implement preventive measures and demonstrate good faith compliance efforts",
            questions: [
          ...
          },
          {
            ...
            order_no: 4,
            summary:
              "Law 25 enables private right of action with statutory damages ($1,000+ for intentional/gross negligence). Document compliance efforts to defend against claims",
            questions: [
          ...
          },
          {
            ...
            description:
              "Continuously improve privacy program based on learnings and regulatory developments",
            order_no: 5,
            summary:
              "Stay current with CAI guidance and regulatory developments. Incorporate lessons learned from incidents and audits. Update policies and procedures as needed",
            questions: [
