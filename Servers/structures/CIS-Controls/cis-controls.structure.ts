  ...
  seed: {
    ...
    "structure": [
      ...
      },
      {
        ...
        "description": "Actively manage all software on the network so only authorized software is installed and can execute",
        "order_no": 2,
        "items": [
          {
          ...
          },
          {
            ...
            "questions": [
              "Is end-of-life software tracked?",
        ...
        "items": [
          {
            ...
            "questions": [
              "Is there a data management policy?",
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "title": "4.2 Establish and Maintain a Secure Configuration Process for Network Infrastructure",
        ...
        "items": [
          {
            ...
            "questions": [
              "Are all accounts inventoried?",
              "Are service accounts tracked?"
            ],
            "evidence_examples": [
              "Account inventory",
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "description": "Establish and follow a process to revoke access to enterprise assets and software",
            "order_no": 2,
            "summary": "Define access revocation process",
            "questions": [
              "How quickly is access revoked?",
              "Is there a termination checklist?"
            ],
            "evidence_examples": [
              "Revocation process",
