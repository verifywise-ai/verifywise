...
export const saudiPdplStructure: FrameworkStructure = {
  ...
  seed: {
    ...
    description:
      "Framework for compliance with Saudi PDPL (since September 2023), SDAIA Ethics Principles, and Generative AI Guidelines (2024)",
    version: "1.0.0",
        ...
        items: [
          {
            ...
            description:
              "Key definitions including personal data, sensitive data, controller, processor, and explicit consent",
            order_no: 1,
          ...
          },
          {
            ...
            description:
              "Law applies to processing in Saudi Arabia and processing of Saudi residents' data",
            order_no: 2,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            evidence_examples: ["Retention policy", "Deletion certificates", "Retention schedule"],
          },
          {
            ...
            evidence_examples: ["Security policy", "Technical controls", "Access control matrix"],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            evidence_examples: ["Monitoring procedures", "Audit reports", "Remediation records"],
          },
        ],
      },
    ],
