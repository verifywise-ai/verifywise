  ...
  seed: {
    ...
    structure: [
        ...
        items: [
          {
            ...
            description:
              "Ensure AI systems contribute to beneficial outcomes for people and society.",
            order_no: 1,
          ...
          },
          {
            ...
            description:
              "Align AI development with sustainable development goals and environmental responsibility.",
            order_no: 2,
          ...
          },
          {
            ...
            description:
              "Ensure AI contributes to inclusive economic growth and reduces inequalities.",
            order_no: 3,
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description:
              "Respect diversity and promote inclusion in AI development and deployment.",
            order_no: 3,
      ...
      },
      {
        ...
        description:
          "There should be transparency and responsible disclosure around AI systems to ensure people understand when they are engaging with them and can challenge outcomes.",
        order_no: 3,
        items: [
          {
      ...
      },
      {
        ...
        description:
          "AI systems should be robust, secure and safe throughout their lifecycle so that they function appropriately and do not pose unreasonable safety risks.",
        order_no: 4,
        items: [
          {
      ...
      },
      {
        ...
        description:
          "Engage with diverse stakeholders throughout the AI lifecycle to ensure AI systems meet societal needs.",
        order_no: 6,
        items: [
          {
