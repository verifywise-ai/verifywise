...
export const bahrainPdplStructure: FrameworkStructure = {
  ...
  seed: {
    ...
    description:
      "Framework for compliance with Bahrain PDPL 30/2018, Central Bank of Bahrain AI Notice (2023), and EDB AI Ethics Pledge",
    version: "1.0.0",
        ...
        items: [
          {
            ...
            description:
              "Key definitions including personal data, sensitive data, data controller, data processor, and consent under Bahrain PDPL",
            order_no: 1,
