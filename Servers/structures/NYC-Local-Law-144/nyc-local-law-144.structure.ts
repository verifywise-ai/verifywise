        ...
        "items": [
          {
            ...
            "order_no": 1,
            "summary": "The organization must determine whether any tool used in hiring or promotion qualifies as an Automated Employment Decision Tool (AEDT) under NYC Local Law 144.",
            "questions": [
        ...
        "items": [
          {
            ...
            "order_no": 1,
            "summary": "Each AEDT must undergo an independent bias audit before use and at least once annually.",
            "questions": [
          ...
          },
          {
            ...
            "order_no": 2,
            "summary": "A summary of the most recent bias audit must be publicly available prior to AEDT use.",
            "questions": [
        ...
        "items": [
          {
            ...
            "order_no": 1,
            "summary": "Candidates and employees must receive notice at least 10 business days before AEDT use.",
            "questions": [
          ...
          },
          {
            ...
            "order_no": 2,
            "summary": "The organization must disclose the type of data collected and the source of that data.",
            "questions": [
        ...
        "items": [
          {
            ...
            "order_no": 1,
            "summary": "Candidates must be allowed to request an alternative evaluation process or reasonable accommodation.",
            "questions": [
        ...
        "items": [
          {
            ...
            "order_no": 1,
            "summary": "Responsibility for compliance must be defined when AEDTs are vendor supplied.",
            "questions": [
