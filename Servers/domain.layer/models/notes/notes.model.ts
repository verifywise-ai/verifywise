...
export enum NotesAttachedToEnum {
  ...
  RISK = "RISK",
  CONTROL = "CONTROL",
  // Generic frameworks (Servers/structures/) — derived as
  // `${framework_type.toUpperCase()}_${entity_type.toUpperCase()}`.
  AI_ETHICS_REQUIREMENT = "AI_ETHICS_REQUIREMENT",
  ALTAI_ASSESSMENT_AREA = "ALTAI_ASSESSMENT_AREA",
  BAHRAIN_PDPL_ARTICLE = "BAHRAIN_PDPL_ARTICLE",
  CCPA_REQUIREMENT = "CCPA_REQUIREMENT",
  CIS_CONTROLS_SAFEGUARD = "CIS_CONTROLS_SAFEGUARD",
  COLORADO_AI_ACT_SECTION = "COLORADO_AI_ACT_SECTION",
  DATA_GOVERNANCE_PRACTICE = "DATA_GOVERNANCE_PRACTICE",
  DORA_REQUIREMENT = "DORA_REQUIREMENT",
  FTC_AI_GUIDELINES_REQUIREMENT = "FTC_AI_GUIDELINES_REQUIREMENT",
  GDPR_ARTICLE = "GDPR_ARTICLE",
  HIPAA_STANDARD = "HIPAA_STANDARD",
  HIPAA_IMPLEMENTATION_SPECIFICATION = "HIPAA_IMPLEMENTATION_SPECIFICATION",
  NIST_CSF_CATEGORY = "NIST_CSF_CATEGORY",
  NIST_CSF_SUBCATEGORY = "NIST_CSF_SUBCATEGORY",
  NYC_LOCAL_LAW_144_REQUIREMENT = "NYC_LOCAL_LAW_144_REQUIREMENT",
  OECD_AI_PRINCIPLES_REQUIREMENT = "OECD_AI_PRINCIPLES_REQUIREMENT",
  PCI_DSS_REQUIREMENT = "PCI_DSS_REQUIREMENT",
  QATAR_PDPL_ARTICLE = "QATAR_PDPL_ARTICLE",
  QUEBEC_LAW25_ARTICLE = "QUEBEC_LAW25_ARTICLE",
  SAUDI_PDPL_ARTICLE = "SAUDI_PDPL_ARTICLE",
  SOC2_CONTROL = "SOC2_CONTROL",
  TEXAS_AI_ACT_SECTION = "TEXAS_AI_ACT_SECTION",
  UAE_PDPL_ARTICLE = "UAE_PDPL_ARTICLE",
}
...
export class NotesModel extends Model<NotesModel> {
  ...
  @Column({
    type: DataType.ENUM(...Object.values(NotesAttachedToEnum)),
    allowNull: false,
  })
