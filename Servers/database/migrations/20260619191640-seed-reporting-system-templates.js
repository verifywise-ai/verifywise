...
const SECTIONS = {
  daily: [
    { key: "current_high_risks", reportSectionKey: "projectRisks", label: "Current high / critical risks", core: true, defaultEnabled: true, supportedScopes: ["project","organization"] },
    { key: "overdue_tasks", reportSectionKey: "projectRisks", label: "Currently overdue / due-soon tasks", core: true, defaultEnabled: true, supportedScopes: ["project","organization"] },
    { key: "open_incidents", reportSectionKey: "incidentManagement", label: "Open / unresolved incidents", core: true, defaultEnabled: true, supportedScopes: ["project","organization"] },
    { key: "vendor_reviews", reportSectionKey: "vendors", label: "Vendor reviews due soon", core: false, defaultEnabled: false, supportedScopes: ["project","organization"] },
    { key: "policy_due", reportSectionKey: "policyManager", label: "Policy reviews due soon", core: false, defaultEnabled: false, supportedScopes: ["project","organization"] }
  ],
  weekly: [
    { key: "ai_portfolio", reportSectionKey: "models", label: "AI portfolio overview", core: true, defaultEnabled: true, supportedScopes: ["organization","project"] },
    { key: "risk_posture", reportSectionKey: "projectRisks", label: "Risk posture", core: true, defaultEnabled: true, supportedScopes: ["organization","project"] },
    { key: "compliance_progress", reportSectionKey: "compliance", label: "Compliance progress", core: true, defaultEnabled: true, supportedScopes: ["organization","project"] },
    { key: "incidents_summary", reportSectionKey: "incidentManagement", label: "Incidents summary", core: false, defaultEnabled: true, supportedScopes: ["organization","project"] }
  ],
  compliance: [
    { key: "framework_progress", reportSectionKey: "clausesAndAnnexes", label: "Framework control progress", core: true, defaultEnabled: true, supportedScopes: ["project","organization"] },
    { key: "missing_evidence", reportSectionKey: "compliance", label: "Missing evidence", core: true, defaultEnabled: true, supportedScopes: ["project","organization"] },
    ...
    try {
      for (const tpl of TEMPLATES) {
        const existing = await queryInterface.sequelize.query(
          ...
          { replacements: { slug: tpl.slug }, type: queryInterface.sequelize.QueryTypes.SELECT, transaction: t });
        ...
        const inserted = await queryInterface.sequelize.query(
          `INSERT INTO verifywise.report_templates
           ...
           RETURNING id`,
          { replacements: { name: tpl.name, slug: tpl.slug, description: tpl.desc, category: tpl.category, default_scope: tpl.default_scope, freq: tpl.recommended_frequency },
