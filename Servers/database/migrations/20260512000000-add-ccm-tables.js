    ...
    try {
      ...
      await queryInterface.sequelize.query(
        `CREATE TABLE IF NOT EXISTS verifywise.ccm_control_tests (
          ...
          control_id INTEGER REFERENCES verifywise.controls(id) ON DELETE SET NULL,
          subcontrol_id INTEGER REFERENCES verifywise.subcontrols(id) ON DELETE SET NULL,
      ...
      await queryInterface.sequelize.query(
        `CREATE TABLE IF NOT EXISTS verifywise.ccm_control_health (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER NOT NULL REFERENCES verifywise.organizations(id) ON DELETE CASCADE,
          control_id INTEGER NOT NULL REFERENCES verifywise.controls(id) ON DELETE CASCADE,
          subcontrol_id INTEGER REFERENCES verifywise.subcontrols(id) ON DELETE CASCADE,
          framework_type VARCHAR(50) NOT NULL,
