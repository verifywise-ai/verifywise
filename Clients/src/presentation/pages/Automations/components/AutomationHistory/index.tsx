            ...
            <Table sx={singleTheme.tableStyles.primary.frame}>
              ...
              >
                <TableRow sx={singleTheme.tableStyles.primary.header.row}>
                  <TableCell
                    sx={{ ...singleTheme.tableStyles.primary.header.cell, width: "50px" }}
                  />
              ...
              <TableBody>
                {logs.map((log) => (
                  <React.Fragment key={log.id}>
                    ...
                    >
                      <TableCell
                        sx={{ ...singleTheme.tableStyles.primary.body.cell, width: "50px" }}
                      >
                        <IconButton
                          size="small"
                          onClick={(e) => {
                                  ...
                                  <Box sx={{ position: "relative", pl: 2 }}>
                                    {log.actions.map((action, idx) => {
                                      ...
                                      return (
                                        <Box
                                          key={idx}
                                          sx={{ position: "relative", pb: isLastStep ? 0 : 3 }}
                                        >
                                          {/* Vertical Line */}
                                          {!isLastStep && (
                                            <Box
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <Box>
                                          ...
                                          {log.status === "partial_success" && (
                                            <Typography
                                              sx={{ fontSize: 12, color: "#795000", mt: 0.5 }}
                                            >
                                          ...
                                          {log.execution_time_ms && (
                                            <Typography
                                              sx={{ fontSize: 11, color: "#8594AC", mt: 0.5 }}
                                            >
