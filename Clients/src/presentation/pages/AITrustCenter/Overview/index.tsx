...
const AITrustCenterOverview: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (terms_and_contact.privacy_visible) {
      if (
        !terms_and_contact.privacy_text ||
        terms_and_contact.privacy_text.trim().length < minLength
      ) {
    ...
    <Box>
      ...
      >
        ...
        <Typography sx={{ ...styles.sectionDescription, mb: 8 }}>
          Compliance badges for certifications and standards (e.g., EU AI Act, NIST, SOC2, ISO
          27001, GDPR).
        </Typography>
        <Box
          sx={{
      ...
      >
        ...
        >
          <ToggleCard
            ...
            onToggle={(_, checked) =>
              handleFieldChange("company_description", "background_visible", checked)
            }
          ...
          >
            <Field
              ...
              onChange={(e) =>
                ...
                handleFieldChange("company_description", "background_text", e.target.value)
              }
              disabled={
                !localFormData.info?.company_description_visible ||
                !localFormData.company_description?.background_visible
          ...
          <ToggleCard
            ...
            onToggle={(_, checked) =>
              handleFieldChange("company_description", "core_benefits_visible", checked)
            }
            disabled={!localFormData.info?.company_description_visible}
          >
            <Field
              ...
              onChange={(e) =>
                ...
                handleFieldChange("company_description", "core_benefits_text", e.target.value)
              }
              disabled={
                !localFormData.info?.company_description_visible ||
                !localFormData.company_description?.core_benefits_visible
          ...
          <ToggleCard
            ...
            onToggle={(_, checked) =>
              handleFieldChange("company_description", "compliance_doc_visible", checked)
            }
            disabled={!localFormData.info?.company_description_visible}
          >
            <Field
              ...
              onChange={(e) =>
                ...
                handleFieldChange("company_description", "compliance_doc_text", e.target.value)
              }
      ...
      >
        ...
        <Typography sx={styles.sectionDescription}>
          Include links to essential documents like the Privacy Policy and Terms of Service. Also
          include email address for privacy/security related questions and incidents.
        </Typography>
        <PrivacyFields>
            ...
            >
              <Box sx={{ minWidth: "160px" }}>
                <Checkbox
                  ...
                  isChecked={localFormData.terms_and_contact?.terms_visible || false}
                  value={localFormData.terms_and_contact?.terms_visible ? "true" : "false"}
                  onChange={(event) =>
                    handleFieldChange("terms_and_contact", "terms_visible", event.target.checked)
                  }
            ...
            >
              <Box sx={{ minWidth: "160px" }}>
                <Checkbox
                  ...
                  isChecked={localFormData.terms_and_contact?.privacy_visible || false}
                  value={localFormData.terms_and_contact?.privacy_visible ? "true" : "false"}
                  onChange={(event) =>
                    handleFieldChange("terms_and_contact", "privacy_visible", event.target.checked)
                  }
                  isDisabled={!localFormData.info?.terms_and_contact_visible}
                />
              </Box>
            ...
            >
              <Box sx={{ minWidth: "160px" }}>
                <Checkbox
                  id="email-visible"
                  label="Company email"
                  isChecked={localFormData.terms_and_contact?.email_visible || false}
                  value={localFormData.terms_and_contact?.email_visible ? "true" : "false"}
                  onChange={(event) =>
                    handleFieldChange("terms_and_contact", "email_visible", event.target.checked)
                  }
                  isDisabled={!localFormData.info?.terms_and_contact_visible}
                />
              </Box>
