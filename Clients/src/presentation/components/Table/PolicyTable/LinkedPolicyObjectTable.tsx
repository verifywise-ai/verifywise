            ...
            .map((row) => (
              ...
              >
                ...
                <TableCell
                  sx={{
                    ...cellStyle,
                    backgroundColor: sortConfig?.key?.toLowerCase().includes("status")
                      ? "background.surface"
                      : "inherit",
                  }}
                >
                ...
                <TableCell
                  sx={{
                    ...cellStyle,
                    backgroundColor: sortConfig?.key?.toLowerCase().includes("author")
                      ? "background.surface"
                      : "inherit",
                  }}
                >
                  <TruncatedCell value={userMap.get(String(row.author_id))} />
                </TableCell>
                ...
                <TableCell
                  sx={{
                    ...cellStyle,
                    backgroundColor: sortConfig?.key?.toLowerCase().includes("updated by")
                      ? "background.surface"
                      : "inherit",
                  }}
                >
                  <TruncatedCell value={userMap.get(String(row.last_updated_by))} />
                </TableCell>
                ...
                <TableCell
                  sx={{
                    position: "sticky",
                    right: 0,
                    background: singleTheme.tableStyles.primary.header.backgroundColors,
                    zIndex: 10,
                  }}
                >
                  <CustomIconButton
