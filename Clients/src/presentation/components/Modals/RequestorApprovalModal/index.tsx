import { Check, ChevronRight, User, Calendar, ClipboardCheck } from "lucide-react";
...
const RequestorApprovalModal: FC<IRequestorApprovalProps> = ({ isOpen, onClose, onRefresh }) => {
  ...
  const handleGroupAccordionChange =
      ...
      if (requestData) {
        ...
        if (requestData.steps) {
          const timeline: ITimelineStep[] = requestData.steps.map((step: any, index: number) => ({
            ...
            status:
              step.status?.toLowerCase() === ApprovalStepStatus.Completed
                          ...
                          {menuGroups.map((group, index) => (
                            <React.Fragment key={group.name}>
                              ...
                              >
                                ...
                                >
                                  <Typography variant="overline" sx={groupTypographyStyle(theme)}>
                          ...
                          >
                            ...
                            {step.comment && (
                              <Stack direction="column" spacing={2}>
                                <Typography sx={commentLabelStyle}>Comment</Typography>
                                <Typography sx={commentTextStyle}>{step.comment}</Typography>
                              </Stack>
                            )}
                          </Stack>
                        </Stack>
